...
class Divu: StaticInst {
	public:
		...
		override void setupDeps() {
			this.srcRegIdx ~= this[RS];
			this.srcRegIdx ~= this[RT];
			this.destRegIdx ~= MiscRegNums.LO;
			this.destRegIdx ~= MiscRegNums.HI;
		}
		...
		override void execute(Thread thread) {
			...
			thread.intRegs[MiscRegNums.LO] = lo;
			thread.intRegs[MiscRegNums.HI] = hi;
		}
}
...
class Mflo: StaticInst {
	public:
		...
		override void setupDeps() {
			this.srcRegIdx ~= MiscRegNums.LO;
			this.destRegIdx ~= this[RD];
		}

		override void execute(Thread thread) {
			thread.intRegs[this[RD]] = thread.intRegs[MiscRegNums.LO];
		}
}
...
class Mfhi: StaticInst {
	public:
		...
		override void setupDeps() {
			this.srcRegIdx ~= MiscRegNums.HI;
			this.destRegIdx ~= this[RD];
		}

		override void execute(Thread thread) {
			thread.intRegs[this[RD]] = thread.intRegs[MiscRegNums.HI];
		}
}
...
class Mtlo: StaticInst {
	public:
		...
		override void execute(Thread thread) {
			thread.intRegs[MiscRegNums.LO] = thread.intRegs[this[RD]];
		}
}
...
class Mthi: StaticInst {
	public:
		...
		override void execute(Thread thread) {
			thread.intRegs[MiscRegNums.HI] = thread.intRegs[this[RD]];
		}
}
